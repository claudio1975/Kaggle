...
# features reduction with autoencoder 
...
h2o.auc(h2o.performance(model_gbm, newdata = validation)) 


## get predictions on test set
gbm_pred <- (h2o.predict(model_gbm, newdata = test_h2o))

summary(gbm_pred, exact_quantiles=T)
...
#turn in R 
pred <- as.data.table((h2o.predict(model_gbm, test_h2o)))
